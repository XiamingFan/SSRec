...
from HSINDataLoader import parse_args
...
def main():
    ...
    # Predicting:
    logger2.info("Training GATs with learned meta-policy. Evaluate NDCG10")
    print("Training GATs with learned meta-policy. Evaluate NDCG10")
