...
def parse_args():
    ...
    parser.add_argument('--layers', type=int, default=3, help='Number of layers. Default is 2')
    ...
    parser.add_argument('--log', default='',
                        help='Name in log')
    parser.add_argument('--mpset', default="[[['2', '1']], [['1', '2']]]", help='Meta-path Set.')
    #parser.add_argument('--mpset', default="[[['2', '1']], [['1', '2']]]",help='Meta-path Set.')
    #parser.add_argument('--mpset', default="[[['2', '1','6','6'],['2','1','6'],['2','4','8','1'],['5','9']], [['4','8'],['3','7']]]",
                        #help='Meta-path Set.')
    #parser.add_argument('--mpset',default="[[['2','1'],['2','4','9','1'],['6','11']], [['1','2'],['5','10'],['3','8'],['4','9'],['4','9','3','8']]]",
                        #help='Meta-path Set.')
    #parser.add_argument('--init', default="specify",
