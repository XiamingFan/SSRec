...
class GAT(nn.Module):
    def __init__(self, in_size, hidden_size, out_size, num_heads, dropout, threshold=0.75):
        ...
        self.layers.append(GATLayer(in_size, hidden_size, num_heads[0], dropout, hidden_size=32, threshold=threshold))
        for l in range(1, len(num_heads)):
            self.layers.append(GATLayer(hidden_size * num_heads[l - 1],
