...
class hgnn_env(object):
    def __init__(self, logger1, logger2, model_name, args, dataset='yelp_data', weight_decay=1e-5):
        ...
        if task == 'rec' or task == 'herec' or task == 'mcrec':
            ...
            self.data = DataLoaderHSIN(logger1, args, dataset)
    ...
    def test_recommender(self, logger2):
        ...
        with torch.no_grad():
            ...
            print(
                f"Test: HR1 : {HR1:.4f}, HR3 : {HR3:.4f}, HR10 : {HR10:.4f},HR20 : {HR20:.4f}, NDCG10 : {NDCG10.item():.4f}, NDCG20 : {NDCG20.item():.4f}")
        return NDCG10.cpu().item()
    ...
    def test_mcrec(self, logger2):
        ...
        hr1, hr3, hr10, hr20, ndcg10, ndcg20 = 0, 0, 0, 0, 0, 0
        ...
        with torch.no_grad():
            ...
            print(
                f"Test: HR1 : {hr1:.4f}, HR3 : {hr3:.4f}, HR10 : {hr10:.4f},HR20 : {hr20:.4f}, NDCG10 : {ndcg10:.4f}, NDCG20 : {ndcg20:.4f}")
        return ndcg10
